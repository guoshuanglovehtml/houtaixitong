...
{   
   ...
   $.get("php/article.php",function (data) 
   {    
	    ...
	    {   
         ...
         // 具体数据
              // id
	     $("<li class='l1'></li>").html("<span>文章id</span>"+e[i].artiID).appendTo(div);
		

		 // 	// 昵称
			$("<li class='l2'></li>").html("<span>标题</span>"+e[i].Title).appendTo(div);

              // 邮箱
			$("<li class='l3'></li>").html("<span>简述</span>"+e[i].KeyWord).appendTo(div);
            
             // 操作
			$("<li class='l4'><span>操作</span><span>详细内容或编辑</span></li>").appendTo(div);
