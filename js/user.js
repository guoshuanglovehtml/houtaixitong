...
{   
   ...
   {    
	    ...
	    {   
         ...
         // 具体数据
              // id
	     $("<li class='l1'></li>").html("<span>用户id</span>"+e[i].userID).appendTo(div);
		

		 // 	// 昵称
			$("<li class='l2'></li>").html("<span>昵称</span>"+e[i].userName).appendTo(div);

              // 邮箱
			$("<li class='l3'></li>").html("<span>邮箱</span>"+e[i].userPsd).appendTo(div);
            
             // 操作
			$("<li class='l4'></li>").html("<span>密码</span>"+e[i].userYX).appendTo(div);
