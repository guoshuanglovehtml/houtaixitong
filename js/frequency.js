...
{   
   ...
   {    
	    ...
	    {   
         ...
         // 具体数据
              // id
	     $("<li class='l1'></li>").html("<span>音频id</span>"+e[i].id).appendTo(div);
		

		 // 	// 昵称
			$("<li class='l2'></li>").html("<span>路径</span>"+e[i].personName).appendTo(div);

              // 邮箱
			$("<li class='l3'></li>").html("<span>播放</span>"+e[i].youxiang).appendTo(div);
            
             // 操作
			$("<li class='l4'><span>操作</span><span>下载</span></li>").appendTo(div);
